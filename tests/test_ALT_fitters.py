...
def test_Fit_Lognormal_Power():
    ...
    assert_allclose(model.a, 3491334253992439.0, rtol=rtol_big, atol=atol) # larger due to variation in python versions
    assert_allclose(model.n, -3.9485517292713515, rtol=rtol_big, atol=atol) # larger due to variation in python versions
...
def test_Fit_Exponential_Dual_Power():
    ...
    assert_allclose(model.c, 8217056028827617.0, rtol=rtol_big, atol=atol) # larger due to variation in python versions
...
def test_Fit_Everything_ALT_single_stress():
    ...
    assert_allclose(model.Lognormal_Power_a, 3736761709377962.0, rtol=rtol_big, atol=atol) # larger due to variation in python versions
    assert_allclose(model.Lognormal_Power_n, -4.802472968284754, rtol=rtol_big, atol=atol)  # larger due to variation in python versions
...
def test_Fit_Everything_ALT_dual_stress():
    ...
    assert_allclose(model.Normal_Dual_Power_c, 1660.1491768564595, rtol=rtol_big, atol=atol)  # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_m, -0.1851882680629996, rtol=rtol_big, atol=atol)  # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_n, -0.16268947942940187, rtol=rtol_big, atol=atol)  # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_sigma, 272.48450447493383, rtol=rtol_big, atol=atol) # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_AICc, 6659.922216946837, rtol=rtol_big, atol=atol) # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_BIC, 6679.087103262704, rtol=rtol_big, atol=atol) # larger due to variation in python versions
    assert_allclose(model.Normal_Dual_Power_loglik, -3325.938762104703, rtol=rtol_big, atol=atol) # larger due to variation in python versions
