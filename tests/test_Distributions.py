...
def test_Weibull_Distribution():
    ...
    assert_allclose(dist.CDF(xvals=xvals, show_plot=False),[0.0, 0.001000000000000002, 0.009999999999999967, 0.1, 0.9, 0.99, 0.999], rtol=tolerance)
    assert_allclose(dist.SF(xvals=xvals, show_plot=False),[1.0, 0.999, 0.99, 0.9, 0.10000000000000002, 0.010000000000000004, 0.001000000000000002], rtol=tolerance)
