...
:math:`\text{Test1 (also known as Inverse Power):} \hspace{6mm} L(S_1,S_2) = c.S_1^m.S_2^n`

:math:`\text{Test2 (also known as Inverse Power):} \hspace{6mm} L(S_1,S_2) = c.S_1^m.S_2^n`
