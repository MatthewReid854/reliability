...
:math:`\text{Exponential:} \hspace{41mm} L(S) = b.{\rm exp} \left(\frac{a}{S} \right)`

:math:`\text{(also known as Arrhenius)}\hspace{120mm} \text{limits:}\hspace{2mm}(-\infty < a < \infty)\hspace{1mm},\hspace{1mm} (b > 0)`
...
:math:`\text{Power:} \hspace{44mm} L(S) = a.S^n`

:math:`\text{(also known as Inverse Power Law)}\hspace{120mm} \text{limits:}\hspace{2mm}(a > 0)\hspace{1mm},\hspace{1mm} (-\infty < n < \infty)`

:math:`\text{Dual-Exponential:} \hspace{4mm} L({S_1},{S_2}) = c.{\rm exp} \left(\frac{a}{S_1} + \frac{b}{S_2} \right)`

:math:`\text{(also known as Temperature-Humidity)}\hspace{120mm} \text{limits:}\hspace{2mm}(-\infty < a < \infty)\hspace{1mm},\hspace{1mm} (-\infty < b < \infty)\hspace{1mm},\hspace{1mm}(c > 0)`
...
:math:`\text{Power-Exponential:} \hspace{5mm} L(S_1,S_2) = c.{\rm exp} \left(\frac{a}{S_1} \right).S_2^n`

:math:`\text{(also known as Thermal-Nonthermal)}\hspace{120mm} \text{limits:}\hspace{2mm}(-\infty < a < \infty)\hspace{1mm},\hspace{1mm} (c>0)\hspace{1mm},\hspace{1mm}(-\infty < n < \infty)`
