...
:math:`\text{PDF:} \hspace{5mm} {PDF}_{model} = p\times{PDF}_1 + (1-p)\times{PDF}_2`

:math:`\text{CDF:} \hspace{5mm} {CDF}_{model} = p\times{CDF}_1 + (1-p)\times{CDF}_2`

:math:`\text{SF:} \hspace{5mm} {SF}_{model} = p\times{SF}_1 + (1-p)\times{SF}_2`
