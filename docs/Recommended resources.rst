...
-    `arXiv <https://arXiv.org>`_ - a database run by Cornell university that provides open access to over 1 million academic papers that have been submitted. If you can't find it here then check on Sci-Hub.
