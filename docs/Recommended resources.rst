...
-    `R (Programming Language) - FaultTree Analysis <http://www.openreliability.org/faulttree-users-tutorial/start-faulttree-on-r/>`_ - Getting started with FaultTree on R.
