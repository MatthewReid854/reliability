...
-    R (Programming Language) - R is one of the most popular programming languages for statistical analysis of data, and there are several libraries that are targeted towards reliability engineering or survival analysis. These include `WeibullR <https://github.com/openrelia/WeibullR.gallery>`_, `abrem <https://rdrr.io/rforge/abrem/>`_, and `survival <https://cran.r-project.org/web/packages/survival/index.html>`_. 
