...
setuptools.setup(
    ...
    keywords=["reliability","engineering","RAM","weibull","lognormal","survival","analysis","censored","data","lifelines","probability","distributions","quality","ALT","accelerated","life","testing"],
